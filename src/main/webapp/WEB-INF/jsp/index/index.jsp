...
<body>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a href="#" data-toggle="dropdown"
						...
						<ul class="dropdown-menu">
							...
							<a class="navbar-brand" href="${linkTo[LoginController].formulario}">Sair</a>
	...
	<div class="section">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<h1 class="text-center text-primary">Universidade Federal de
						Campina Grande</h1>
				</div>
			</div>
		</div>
	...
	<div class="section">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<h2 class="text-left text-muted">SCP - Sistema de Cadastro de
						Projetos</h2>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					<ul class="lead text-muted">
						<li><a href="${linkTo[LoginController].formulario}">
								Logar</a></li>
						<li><a href="${linkTo[ProjetoController].lista}"> Lista
								de Pesquisadores</a></li>
					</ul>
				</div>
			</div>
		</div>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-4">
					...
					<p class="text-left">Lorem ipsum dolor sit amet, adipiscing
